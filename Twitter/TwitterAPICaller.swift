...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "ntjlvRMIuRkz097gAaAwR5g2m", consumerSecret: "bO8Z77Zf2CpciEn9zqv0KUWaTpcBR5nKxAfwC0H4uS4kDo4lX3")
    var loginSuccess: (() -> ())?
    ...
    // Create function for posting tweets
    func postTweet(tweetString: String, success: @escaping () -> (), failure: @escaping (Error) -> ()) {
        // url from Twitter API for posting tweets
